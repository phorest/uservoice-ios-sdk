Pod::Spec.new do |s|
  ...
  s.description   = "UserVoice for iOS allows you to embed UserVoice directly in your iPhone or iPad app. Phorest Version that supporte WKWebView"
  s.homepage      = "http://www.uservoice.com/mobile"
  s.license       = { :type => 'Apache License, Version 2.0', :file => 'LICENSE.md' }
  s.author        = 'UserVoice'
  s.platform      = :ios, '6.0'
  s.source        = { :git => "https://github.com/phorest/uservoice-ios-sdk.git", :tag => "3.3" }
